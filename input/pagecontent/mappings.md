Use this page to navigate the detailed ISO-to-EU Patient Summary mapping pages. Each page provides two tables:

- ISO 27269 → EU Patient Summary
- EU Patient Summary → ISO 27269

Legend (conformance): M = Mandatory, R = Required, RK = Required if known, O = Optional, C = Conditional.
