...
This collaborative effort also includes representatives from the **MyHealth@EU Solution Providers**.

The development of this Implementation Guide has been supported by the **xShare**, **XpanDH** projects and the **Xt-EHR Joint Action**, which provided expertise, alignment with European health policy priorities, and validation of the specifications to ensure consistency with the requirements of the European Health Data Space (EHDS)
