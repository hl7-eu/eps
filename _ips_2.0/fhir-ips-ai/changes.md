# Changes - International Patient Summary Implementation Guide v2.0.0
...
* Medication form terminology binding is not SNOMED-CT ([FHIR-47327](https://jira.hl7.org/browse/FHIR-47327)) Include Must Support obligations on the resource profiles ([FHIR-47511](https://jira.hl7.org/browse/FHIR-47511))
...
* IPS should provide clear guidance on exchange of Name To Use ([FHIR-47781](https://jira.hl7.org/browse/FHIR-47781)) add address and telecom elements to OrganizationIPS with mustSupport/obligation ([FHIR-47929](https://jira.hl7.org/browse/FHIR-47929))
* Include Results with a pending status in the IPS ([FHIR-48336](https://jira.hl7.org/browse/FHIR-48336))
* Relax DiagnosticReport.category constraints ([FHIR-49901](https://jira.hl7.org/browse/FHIR-49901)) section-note: relax max cardinality to * ([FHIR-50271](https://jira.hl7.org/browse/FHIR-50271))
...
* Use SHALL:populate for required sections , SHOULD:populate-if-known for recommended sections ([FHIR-50368](https://jira.hl7.org/browse/FHIR-50368)) Remove display obligations for Bundle profile items marked with MustSupport ([FHIR-50370](https://jira.hl7.org/browse/FHIR-50370))
...
* Explicit modelling of DAR missing on required data elements with Must Support/Obligations ([FHIR-50862](https://jira.hl7.org/browse/FHIR-50862)) Add IPS Patient and Composition obligations of SHALL:populate ([FHIR-50890](https://jira.hl7.org/browse/FHIR-50890))
...
* Relax cardinality on Condition.clinicalStatus - exception given Required ValueSet deficiency ([FHIR-43299](https://jira.hl7.org/browse/FHIR-43299) ) remove invariant pat-cnt-2or3-char (Patient country code) ([FHIR-43370](https://jira.hl7.org/browse/FHIR-43370) )
...
* Addition of [Bundle Profile](./StructureDefinition-Bundle-uv-ips.md)
* Addition of [MedicationRequest Profile](./StructureDefinition-MedicationRequest-uv-ips.md)
