# Results Specimen Type - IPS - International Patient Summary Implementation Guide v2.0.0

## ValueSet: Results Specimen Type - IPS 
...
* Include codes from[`http://snomed.info/sct`](http://www.snomed.org/)version Not Stated (use latest from terminology server) where concept descends from 123038009 (Specimen)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/ips/ValueSet/results-specimen-type-uv-ips",
  "version" : "2.0.0",
