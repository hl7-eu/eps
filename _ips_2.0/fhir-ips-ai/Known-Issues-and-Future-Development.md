# Known Issues and Future Development - International Patient Summary Implementation Guide v2.0.0
...
1. Gather feedback on the IPS[$summary operation](./OperationDefinition-summary.md)introduced in STU1.1 of the this guide.
1. Gather feedback on how Provenance could be used in IPS[FHIR-40610](https://jira.hl7.org/browse/FHIR-40610)
1. Loosen Observation profile for alcohol usage[FHIR-40802](https://jira.hl7.org/browse/FHIR-40802)
1. Provide IPS viewing requirements[FHIR-41630](https://jira.hl7.org/browse/FHIR-41630)
1. Remove identifying information requirements in IPS[FHIR-43721](https://jira.hl7.org/browse/FHIR-43721)
1. Check value Set OID alignment between FHIR and CDA IPS IGs[FHIR-46169](https://jira.hl7.org/browse/FHIR-46169)
1. Add NutritionIntake Observation profile in Social History[FHIR-46923](https://jira.hl7.org/browse/FHIR-46923)
1. Add Patient Travel History[FHIR-47930](https://jira.hl7.org/browse/FHIR-47930)
1. Add NUVA as additional vaccine binding[FHIR-49146](https://jira.hl7.org/browse/FHIR-49146)
1. Add 'disability' to ValueSet: Problem Type - IPS[FHIR-49218](https://jira.hl7.org/browse/FHIR-49218)
1. Add CarePlan (IPS) Profile, based on ISO 27269[FHIR-49905](https://jira.hl7.org/browse/FHIR-)
1. Guidance on laterality in IPS[FHIR-50042](https://jira.hl7.org/browse/FHIR-)
1. Add a CareTeam section, and describe how to use it for patient advocate / legal power of attorney[FHIR-50098](https://jira.hl7.org/browse/FHIR-)
1. Include more detail in section about identifier usage[FHIR-51507](https://jira.hl7.org/browse/FHIR-)
1. Clarify intent and possible rules for separation between Current and Past problems[FHIR-51511](https://jira.hl7.org/browse/FHIR-)
