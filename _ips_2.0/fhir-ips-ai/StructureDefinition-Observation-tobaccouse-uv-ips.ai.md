# Observation Social History - Tobacco Use (IPS) - International Patient Summary Implementation Guide v2.0.0

## Resource Profile: Observation Social History - Tobacco Use (IPS) 
...
* Examples for this Profile: [Observation/tobacco-use-example](Observation-tobacco-use-example.md)
* CapabilityStatements using this Profile: [IPS Server Capability Statement](CapabilityStatement-ips-server.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.ips|current/StructureDefinition/Observation-tobaccouse-uv-ips)
...
Other representations of profile: [CSV](../StructureDefinition-Observation-tobaccouse-uv-ips.csv), [Excel](../StructureDefinition-Observation-tobaccouse-uv-ips.xlsx), [Schematron](../StructureDefinition-Observation-tobaccouse-uv-ips.sch) 
