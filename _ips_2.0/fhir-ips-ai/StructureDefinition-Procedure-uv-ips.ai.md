# Procedure (IPS) - International Patient Summary Implementation Guide v2.0.0
...
* Examples for this Profile: [Procedure/eumfh-39-07-1](Procedure-eumfh-39-07-1.md) and [Procedure/procedure-missing-performed](Procedure-procedure-missing-performed.md)
* CapabilityStatements using this Profile: [IPS Server Capability Statement](CapabilityStatement-ips-server.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.ips|current/StructureDefinition/Procedure-uv-ips)
...
Other representations of profile: [CSV](../StructureDefinition-Procedure-uv-ips.csv), [Excel](../StructureDefinition-Procedure-uv-ips.xlsx), [Schematron](../StructureDefinition-Procedure-uv-ips.sch) 
    ...
    "element" : [
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "description" : "SNOMED CT procedure code set or a code for absent/unknown procedure",
