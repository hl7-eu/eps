# Observation Pregnancy - Expected Delivery Date (IPS) - International Patient Summary Implementation Guide v2.0.0

## Resource Profile: Observation Pregnancy - Expected Delivery Date (IPS) 
...
* Refer to this Profile: [Observation Pregnancy - Status (IPS)](StructureDefinition-Observation-pregnancy-status-uv-ips.md)
* Examples for this Profile: [Observation/pregnancy-edd-example](Observation-pregnancy-edd-example.md)
* CapabilityStatements using this Profile: [IPS Server Capability Statement](CapabilityStatement-ips-server.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.ips|current/StructureDefinition/Observation-pregnancy-edd-uv-ips)
...
Other representations of profile: [CSV](../StructureDefinition-Observation-pregnancy-edd-uv-ips.csv), [Excel](../StructureDefinition-Observation-pregnancy-edd-uv-ips.xlsx), [Schematron](../StructureDefinition-Observation-pregnancy-edd-uv-ips.sch) 
