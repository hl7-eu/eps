# Results Presence/Absence - IPS - International Patient Summary Implementation Guide v2.0.0

## ValueSet: Results Presence/Absence - IPS 
...
* Include codes from[`http://snomed.info/sct`](http://www.snomed.org/)version Not Stated (use latest from terminology server) where concept descends from 260411009 (Presence findings)
* Include codes from[`http://snomed.info/sct`](http://www.snomed.org/)version Not Stated (use latest from terminology server) where concept descends from 272519000 (Absence findings)
...
This value set expansion contains 65 concepts.
