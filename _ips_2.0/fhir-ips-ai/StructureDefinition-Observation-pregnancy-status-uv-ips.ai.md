# Observation Pregnancy - Status (IPS) - International Patient Summary Implementation Guide v2.0.0
...
* Examples for this Profile: [Observation/pregnancy-status-example](Observation-pregnancy-status-example.md)
* CapabilityStatements using this Profile: [IPS Server Capability Statement](CapabilityStatement-ips-server.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.ips|current/StructureDefinition/Observation-pregnancy-status-uv-ips)
...
Other representations of profile: [CSV](../StructureDefinition-Observation-pregnancy-status-uv-ips.csv), [Excel](../StructureDefinition-Observation-pregnancy-status-uv-ips.xlsx), [Schematron](../StructureDefinition-Observation-pregnancy-status-uv-ips.sch) 
