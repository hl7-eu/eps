# Medicine Active Substances - IPS - International Patient Summary Implementation Guide v2.0.0

## ValueSet: Medicine Active Substances - IPS 
...
* Include codes from[`http://snomed.info/sct`](http://www.snomed.org/)version Not Stated (use latest from terminology server) where concept descends from 410942007 (Drug or medicament (substance))
