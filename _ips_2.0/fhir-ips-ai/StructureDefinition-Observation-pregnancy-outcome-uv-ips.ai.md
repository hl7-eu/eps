# Observation Pregnancy - Outcome (IPS) - International Patient Summary Implementation Guide v2.0.0
...
* Examples for this Profile: [Observation/pregnancy-outcome-example](Observation-pregnancy-outcome-example.md)
* CapabilityStatements using this Profile: [IPS Server Capability Statement](CapabilityStatement-ips-server.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.ips|current/StructureDefinition/Observation-pregnancy-outcome-uv-ips)
...
Other representations of profile: [CSV](../StructureDefinition-Observation-pregnancy-outcome-uv-ips.csv), [Excel](../StructureDefinition-Observation-pregnancy-outcome-uv-ips.xlsx), [Schematron](../StructureDefinition-Observation-pregnancy-outcome-uv-ips.sch) 
